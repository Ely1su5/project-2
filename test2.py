...
while True:
    ...
    # Crear máscara basada en umbrales LAB
    ...
    # Concatenar todas las imágenes horizontalmente
    combined = np.hstack((frame, masked_frame, l_3ch, a_3ch, b_3ch, mask_3ch))
    ...
    # Mostrar resultado
    cv2.imshow('Original | Masked | L | A | B | Mask', resized)
